...
// A ControlMessageIPv6PacketInfo is IPV6_PKTINFO socket control message.
//
...
// SizeOfControlMessageIPv6PacketInfo is the size of an IPV6_PKTINFO
// control message.
